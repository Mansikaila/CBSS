<?php
    include("classes/cls_menu_right_master.php");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <section class="content-header">
        ...
        <li><a href="srh_menu_right_master.php"><i class="fa fa-dashboard"></i> Menu Right Master</a></li>
    ...
    <div class="col-md-12" style="padding:0;">
       <div class="box box-info">
            <!-- form start -->
            <form id="masterForm" action="classes/cls_menu_right_master.php"  method="post" class="form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
            <div class="box-body">
    ...
    <?php
            ...
            global $_dbh;
            $hidden_str="";
            $table_name="tbl_menu_right_master";
            $lbl_array=array();
            $field_array=array();
            $err_array=array();
...
<!-- .box-footer -->
              <div class="box-footer">
               <?php echo  $hidden_str; ?>
                <!--<input type="hidden" id="menu_right_id" name="menu_right_id" value= "<?php if(isset($_bll->_mdl))  echo $_bll->_mdl->_menu_right_id; else echo 0; ?>">-->
                ...
                <input type="button" class="btn btn-primary" id="btn_search" name="btn_search" value="Search" onclick="window.location='srh_menu_right_master.php'">
...
document.addEventListener("DOMContentLoaded", function () {    
    ...
    function checkDuplicate(input) {
       ...
       let id_column="<?php echo "menu_right_id" ?>";
       let id_value=document.getElementById(id_column).value;
       $.ajax({
            url: "<?php echo "classes/cls_menu_right_master.php"; ?>",
            type: "POST",
            data: { column_name: input.name, column_value:column_value, id_name:id_column,id_value:id_value,table_name:"<?php echo "tbl_menu_right_master"; ?>",type:"ajax"},
