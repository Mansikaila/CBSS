  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12" style="padding:0;">
       <div class="box box-info">
            <!-- form start -->
            <form id="masterForm" action="classes/cls_user_master.php"  method="post" class="form-horizontal needs-validation" novalidate>
            <div class="box-body">
...
<!-- .box-footer -->
              <div class="box-footer">
               <?php echo  $hidden_str; ?>
                <!--<input type="hidden" id="user_id" name="user_id" value= "<?php if(isset($_bll->_mdl))  echo $_bll->_mdl->_user_id; else echo 0; ?>">-->
...
document.addEventListener("DOMContentLoaded", function () {    
    ...
    function checkDuplicate(input) {
       ...
       let id_column="<?php echo "user_id" ?>";
       let id_value=document.getElementById(id_column).value;
       $.ajax({
            url: "<?php echo "classes/cls_user_master.php"; ?>",
            type: "POST",
            data: { column_name: input.name, column_value:column_value, id_name:id_column,id_value:id_value,table_name:"<?php echo "tbl_user_master"; ?>",type:"ajax"},
