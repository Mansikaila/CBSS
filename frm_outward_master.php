...
<div class="modal fade" id="pendingInwardModal" tabindex="-1" aria-labelledby="pendingInwardLabel" aria-hidden="true">
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td>" . htmlspecialchars($row['item'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['variety'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['inward_qty'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['packing_unit'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['inward_wt'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['stock_qty'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['stock_wt'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['out_qty'] ?? 'N/A') . "</td>";
        echo "<td>" . htmlspecialchars($row['loading_charge'] ?? 'N/A') . "</td>";
