  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12" style="padding:0;">
       <div class="box box-info">
            <!-- form start -->
            <form id="masterForm" action="classes/cls_city_master.php"  method="post" class="form-horizontal needs-validation" novalidate>
            <div class="box-body">
...
<!-- .box-footer -->
              <div class="box-footer">
               <?php echo  $hidden_str; ?>
                <!--<input type="hidden" id="city_id" name="city_id" value= "<?php if(isset($_bll->_mdl))  echo $_bll->_mdl->_city_id; else echo 0; ?>">-->
