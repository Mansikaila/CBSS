  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <section class="content-header">
        ...
        <li><a href="srh_user_right_master.php"><i class="fa fa-dashboard"></i> User Right Master</a></li>
    ...
    <?php
            ...
            global $_dbh;
            $hidden_str="";
            $table_name="tbl_user_right_master";
            $lbl_array=array();
            $field_array=array();
            $err_array=array();
...
document.addEventListener("DOMContentLoaded", function () {    
    ...
    function checkDuplicate(input) {
       ...
       let id_column="<?php echo "user_right_id" ?>";
       let id_value=document.getElementById(id_column).value;
       $.ajax({
            url: "<?php echo "classes/cls_user_right_master.php"; ?>",
            type: "POST",
            data: { column_name: input.name, column_value:column_value, id_name:id_column,id_value:id_value,table_name:"<?php echo "tbl_user_right_master"; ?>",type:"ajax"},
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbarSupportedContent">
          <ul class="nav navbar-nav mr-auto">
              <li class="nav-item"><a href="dashboard.php" class="nav-link"><i class="fa fa-home"></i></a></li>
           <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Master <span class="caret"></span></a>
             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="srh_country_master.php">Country</a>
                <a class="dropdown-item" href="srh_state_master.php">State</a>
                <a class="dropdown-item" href="srh_city_master.php">City</a>
                 <a class="dropdown-item" href="srh_district_master.php">District</a>
                <a class="dropdown-item" href="srh_customer_master.php">Customer</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Account Group</a>
                <a class="dropdown-item" href="#">Account</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="srh_unit_master.php">Unit</a>
                <a class="dropdown-item" href="srh_item_master.php">Item</a>
                <a class="dropdown-item" href="srh_chamber_master.php">Chamber</a>
                <a class="dropdown-item" href="srh_floor_master.php">Floor</a>
                <a class="dropdown-item" href="srh_rack_master.php">Rack</a>
                 <a class="dropdown-item" href="srh_location_master.php">Location</a>
                 <a class="dropdown-item" href="srh_item_unit_master.php">Item_unit Mapping</a>
                 <a class="dropdown-item" href="srh_itemunit_master.php">Item_unit</a>
                <a class="dropdown-item" href="#">Item Rent Price List</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Operator</a>
                <a class="dropdown-item" href="#">GST Commodity</a>
                <a class="dropdown-item" href="#">Flag List</a>
                <a class="dropdown-item" href="#">Help</a>
                <a class="dropdown-item" href="#">Switch Year</a>
              </div>
            </li>
              <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Transaction <span class="caret"></span></a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="srh_purchase_order_master.php">Order</a>
                <a class="dropdown-item" href="srh_purchase_inward_master.php">Inward</a>
                <a class="dropdown-item" href="#">Outward</a>
                <a class="dropdown-item" href="srh_issue_slip.php">Issue Slip</a>
                <a class="dropdown-item" href="srh_return_slip.php">Return Slip</a>
                  <a class="dropdown-item" href="srh_order_acceptance_master.php">Order Acceptance</a>
                  <a class="dropdown-item" href="srh_dispatch_master.php">Order Dispatch </a>
                <a class="dropdown-item" href="srh_invoice_master.php">Invoice</a>
                <a class="dropdown-item" href="#">Item Stock</a>
                <a class="dropdown-item" href="#">Receipt</a>
                <a class="dropdown-item" href="srh_payment_master.php">Payment</a>
                <a class="dropdown-item" href="#">Contra</a>
                <a class="dropdown-item" href="#">Journal</a>
                <a class="dropdown-item" href="#">Change Location</a>
              </div>
            </li>
              <li class="dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Report <span class="caret"></span></a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#">Inward Summary</a>
                <a class="dropdown-item" href="#">Outward Summary</a>
                <a class="dropdown-item" href="#">Inward Outward Summary</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Invoice Summary</a>
                <a class="dropdown-item" href="#">Invoice GST Summary</a>
                <a class="dropdown-item" href="#">Lot No. wise Invoice Summary</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Party Label</a>
                <a class="dropdown-item" href="#">Party wise Inward Balance</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Location Detail View</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Lot Statement</a>
                  <a class="dropdown-item" href="#">Item Statement</a>
                <a class="dropdown-item" href="#">Item Stock Statement</a>
                <a class="dropdown-item" href="#">Yearly Stock Report</a>
                <a class="dropdown-item" href="#">Item Rent Price List Report</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Rent Valuation</a>        
                <a class="dropdown-item" href="#">Cover Print</a>
                <a class="dropdown-item" href="#">Customer List</a>               
              </div>
            </li>
              <li class="dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Account <span class="caret"></span></a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#">Day Book</a>
                <a class="dropdown-item" href="#">Cash & Bank</a>
                <a class="dropdown-item" href="#">Account Ledger</a>
                <a class="dropdown-item" href="#">Trial Balance</a>
                <a class="dropdown-item" href="#">Trading Account</a>
                  <a class="dropdown-item" href="#">Profit & Loss</a>
                  <a class="dropdown-item" href="#">Balance Sheet</a>
                  <a class="dropdown-item" href="#">List of Account</a>
              </div>
            </li>
              <li class="dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admin <span class="caret"></span></a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="company_master.php">Company</a>
                <a class="dropdown-item" href="#">Company Year</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Menu</a>
                <a class="dropdown-item" href="#">Module</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="srh_user_master.php">User Master</a>
                <a class="dropdown-item" href="#">User Right</a>
                <!-- Adding modules to the "User Right" dropdown menu -->
                <?php
                $user_right_modules = [
                    "Country" => "srh_country_master.php",
                    "State" => "srh_state_master.php",
                    "City" => "srh_city_master.php",
                    "District" => "srh_district_master.php",
                    "Customer" => "srh_customer_master.php",
                    "Unit" => "srh_unit_master.php",
                    "Item" => "srh_item_master.php",
                    "Chamber" => "srh_chamber_master.php",
                    "Floor" => "srh_floor_master.php",
                    "Rack" => "srh_rack_master.php",
                    "Location" => "srh_location_master.php",
                    "Item_unit Mapping" => "srh_item_unit_master.php",
                    "Item_unit" => "srh_itemunit_master.php",
                ];
                foreach ($user_right_modules as $module => $link) {
                    echo "<a class='dropdown-item' href='{$link}'>{$module}</a>";
                    if (in_array($module, ["Customer", "Account Group"])) {
