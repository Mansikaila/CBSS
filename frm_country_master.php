  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <section class="content-header">
        ...
        <li><a href="srh_country_master.php"><i class="fa fa-dashboard"></i> Country Master</a></li>
...
<!-- .box-footer -->
              <div class="box-footer">
               <?php echo  $hidden_str; ?>
                <!--<input type="hidden" id="country_id" name="country_id" value= "<?php if(isset($_bll->_mdl))  echo $_bll->_mdl->_country_id; else echo 0; ?>">-->
...
document.addEventListener("DOMContentLoaded", function () {    
    ...
    function checkDuplicate(input) {
       ...
       let id_column="<?php echo "country_id" ?>";
       let id_value=document.getElementById(id_column).value;
       $.ajax({
            url: "<?php echo "classes/cls_country_master.php"; ?>",
            type: "POST",
            data: { column_name: input.name, column_value:column_value, id_name:id_column,id_value:id_value,table_name:"<?php echo "tbl_country_master"; ?>",type:"ajax"},
