...
//    
//    const isOpen = headerElem.nextElementSibling && headerElem.nextElementSibling.classList.contains('menu-body');
//
//    allMenuBodies.forEach(div => div.remove());
//
...
//        menuBody.className = 'card-body menu-body';
...
//}
    ...
    if (!isOpen) {
        ...
        // If no existing menu body, create a new one
