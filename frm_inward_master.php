...
function calculateTotals() {
   ...
   // Only in Add Mode (not Edit Mode, not manually edited)
    const unloadingChargeInput = document.getElementById('unloading_charge');
    if (unloadingChargeInput && !isUnloadingChargeManuallyEdited && !isEditMode()) {
...
function isEditMode() {
    return document.getElementById('transactionmode')?.value === "U";
}
