...
{   
    ...
    public function pageSearch()
    {
        ...
        $sql="CAll csms1_search('t.city_name, t.state_id, t.country_id, t.city_name, t.country_id, t2.state_name, t.city_id','tbl_city_master t INNER JOIN tbl_state_master t2 ON t.state_id=t2.state_id[...])";
        echo "
        ...
        <thead>
            ...
            <th> City Name <br><input type=\"text\" data-index=\"1\" placeholder=\"Search City Name\" /></th> 
                         <th> State Id <br><input type=\"text\" data-index=\"2\" placeholder=\"Search State Id\" /></th> 
                         <th> Country Id <br><input type=\"text\" data-index=\"3\" placeholder=\"Search Country Id\" /></th> 
                         </tr>
        </thead>
        <tbody>";
         $_grid="";
    ...
    public function checkDuplicate($column_name,$column_value,$id_name,$id_value,$table_name) {
        global $_dbh;
        try {
    ...
    public function fetchCountry()
    {
        ...
        $sql = "SELECT country_id FROM tbl_state_master WHERE state_id = ?";
        $stmt = $_dbh->prepare($sql);
...
if(isset($_POST["action"]) && $_POST["action"]=="fetchCountry") {
    $_bll->fetchCountry();
    exit;
}
